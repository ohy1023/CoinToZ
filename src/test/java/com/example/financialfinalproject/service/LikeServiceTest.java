...
class LikeServiceTest {
    ...
    private final User user = User.builder()
            .id(1).userName("개발의민족").password("1234")
            .build();
    ...
    class test_Like {
        ...
        void addLikeCount_sucess() {
            ...
            boolean likeResponse = likeService.addLikeCount(post.getId(), user.getUserName());
        ...
        void deleteLikeCount() {
            ...
            boolean likeResponse = likeService.deleteLikeCount(post.getId(), user.getUserName());
            assertTrue(likeResponse);
        }
    }
    ...
    class test_DisLike {
        ...
        void addDisLikeCount_sucess() {
            ...
            boolean DislikeResponse = likeService.addDisLikeCount(post.getId(), user.getUserName());
        ...
        void deleteDisLikeCount() {
            ...
            boolean DislikeResponse = likeService.deleteDisLikeCount(post.getId(), user.getUserName());
            assertTrue(DislikeResponse);
