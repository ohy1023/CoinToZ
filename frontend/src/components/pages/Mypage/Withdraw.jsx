            ...
            <div className={styles.MemberContent}>
              <div className={styles.MemberCard}>
                <div className={styles.MemberCardHeader}>
                  <Box>
                    <h1 style={{ display: 'inline', marginRight: '740px' }}>
                      원화 출금
                    </h1>
                    <Button onClick={handleChangeCount} type="button">
                      새로고침
                    </Button>
                  </Box>
                </div>
                <div className={styles.MemberCardBody}>
                  ...
                  <ul>
                    <li style={{ marginLeft: '5px' }}>
                      ✔ 업비트에서 계좌인증 후 사용가능합니다.
                    </li>
                    <li style={{ marginLeft: '5px' }}>
                      ✔ 최소 5000원 부터 출금 가능합니다.
                    </li>
                    <li style={{ marginLeft: '5px' }}>
                      ✔ 2차 인증 성공 후 출금 진행됩니다.
                    </li>
                    <li style={{ marginLeft: '5px' }}>
                      ✔ 해당 서비스 이용 시 수수료(1000 KRW)가 발생합니다.
                    </li>
                    <li style={{ marginLeft: '5px' }}>
                      ✔ 출금까지 약 1분 소요됩니다.
                    </li>
                    <li style={{ marginLeft: '5px' }}>
                      ✔ 출금 가능 금액 (수수료 적용) : {money - 1000} KRW{' '}
                    </li>
                  </ul>
                  <Box noValidate sx={{ mt: 1 }}>
                    ...
                    >
                      <MenuItem disabled value="2차 인증 방식">
                        2차 인증 방식
                      </MenuItem>
