    ...
    <Row>
      <div className="root">
        ...
        <div style={{ float: 'left' }}>
          <Link className="btn btn-outline-dark" to="/community">
            <ListIcon></ListIcon> 글 목록
          </Link>
        </div>

        <div className="topButtonGroup">
          <button className="btn btn-outline-dark" onClick={likePost}>
            <FavoriteIcon />
            좋아요
          </button>
          {userName === board.userName ? (
            <>
              <Link
                ...
                to="/postUpdate"
                state={{ board: postUpdate }}
              >
                <EditIcon></EditIcon> 수정
              </Link>
              <button className="btn btn-outline-danger" onClick={deleteBoard}>
                <DeleteIcon></DeleteIcon> 삭제
              </button>
            </>
          ) : (
            <>
        ...
        <div className="details">
          <Row>
            <Col span={4} className="th">
              작성자
            </Col>
            <Col span={8} className="td">
              {board.userName}
            </Col>
          ...
          <Row>
            ...
            <Col span={20} className="td">
              <pre style={{ minHeight: '300px' }}>{board.body}</pre>
            </Col>
          </Row>
        </div>
            ...
            <Row>
              ...
              <Col span={4}>
                <Button
                  ...
                  variant="contained"
                  size="large"
                  sx={{ width: 0.8, height: 0.8, mt: 0, mb: 3, ml: 3 }}
                >
                  댓글 등록
                </Button>
              </Col>
